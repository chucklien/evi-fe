...
const Spinner: FC = () => (
  ...
  >
    ...
    <div style={{ width: '100%', marginTop: '10px', textAlign: 'center' }}>Connecting</div>
  </div>
);

function getTop3Expressions(expressionOutputs: Hume.empathicVoice.EmotionScores) {
...
export const ExampleComponent = () => {
  ...
  const [textInputType, setTextInputType] = useState<'user' | 'assistant'>('user');
  ...
  const callDuration = (
    <div>
      ...
      <div>{isReady ? callDurationTimestamp : 'n/a'}</div>
    </div>
  );
            ...
            .with('connected', () => (
              <>
                ...
                {isMuted ? (
                  ...
                  <button className="rounded border border-neutral-500 p-2" onClick={() => mute()}>
                    Mute mic
                  </button>
                )}
                <button
                ...
                {false && (
                  <div className="flex flex-col justify-start gap-2">
                    <div className="text-sm font-medium uppercase">Send a text input message</div>
                ...
                {isReady && (
                  <div>
                    ...
                    <div className={'w-full bg-neutral-800 font-mono text-sm text-white'}>
                ...
                {isReady && (
                  <div>
                    <div className={'text-sm font-medium uppercase'}>Last assistant message</div>
                    {assistantMessages.length > 0 ? (
                      <div className="bg-neutral-800 font-mono text-sm text-white">
                        {JSON.stringify(assistantMessages[assistantMessages.length - 1], null, 2)}
                      </div>
                    ) : (
